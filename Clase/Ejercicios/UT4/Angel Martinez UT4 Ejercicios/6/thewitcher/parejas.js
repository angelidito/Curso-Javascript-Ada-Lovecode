    ...
    if (soloImpar(oJuego.cartas[oJuego.pulsada[0]]) == soloImpar(oJuego.cartas[oJuego.pulsada[1]])) {
        ...
        if (oJuego.aciertos * 2 == MAXIMO_FICHAS) {
            ...
            alert("¡¡¡¡BIEN JUGADO!!!! \n" +
                ...
                "\ny solo lo has tenido que intentarlo " + oJuego.intentos + " veces"
            );
        }
        oJuego.pulsada[0] = -1;
        oJuego.pulsada[1] = -1;
...
function bienvenida() {
    alert("Bienvenid@ a The Witcher III Juegode parejas.\nBusca las parejas de los personajes prncipales de The Witcher III");
    carga();
}